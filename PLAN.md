...
9. **The pull request body carries the acceptance criteria** from section 6 with
   each one ticked or explicitly reported as missed. A phase that reports a miss
   honestly is finished. A phase that hides one is not.
